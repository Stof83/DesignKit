...
///
/// The `IsHidden` modifier allows you to conditionally hide or show a SwiftUI view by setting the `hidden` property to `true` or `false`. Additionally, you can choose to either completely remove the view from the layout or just hide it, using the `remove` property.
///
/// Example usage:
/// ```
/// Text("Label")
...
struct IsHidden: ViewModifier {
    ...
    /// A boolean value indicating whether the view should be hidden.
    var hidden = false
